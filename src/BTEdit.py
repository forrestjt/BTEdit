...
class BTEditWindow(wx.Panel):
    ...
    def OnNew(self, event):
      ...
      self.nodes.append(mNode())
      self.nodes.append(mNode())
      self.nodes[0].Set(50,70)
      self.nodes[1].Set(130,10)
      self.nodes[2].Set(220,70)
      self.nodes[1].setName("Root")
      self.nodes[1].addChild(self.nodes[0])
      self.nodes[1].addChild(self.nodes[2])
      self.filename = 0
      self.focusNode = 0
      self.Refresh()
